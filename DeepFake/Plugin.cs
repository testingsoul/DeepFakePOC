...
namespace DeepFake
{
    public class Plugin
    {
        private string _name = "DeepFake Plugin";
        private string _description = "Description DeepFake Plugin";
        private frmDeepFake main = new frmDeepFake();

        public static frmDeepFake mainForm;
        ...
        public Plugin()
        {
            if (Plugin.mainForm == null)
                Plugin.mainForm = new frmDeepFake();
